...
class MotionFormer(VisionTransformer):
    ...
    def __init__(
        ...
        self.mformer_cfg_path = (
            Path(__file__).absolute().parent / "motionformer_src" / cfg_fname
        )
    ...
    def forward(self, x, for_loop: bool = False, cont_mask: torch.Tensor = None):
        ...
        ):  # lazy execution, throws AttributeError
    ...
    def forward_segments(
        self, x, orig_shape: tuple, cont_mask: torch.Tensor = None
    ) -> torch.Tensor:
